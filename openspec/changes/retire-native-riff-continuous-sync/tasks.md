...
- [ ] 4.1 Add Browser/manager entrypoints for explicit Native Riff import preview/apply and explicit old-card adoption preview/apply.
- [ ] 4.2 Replace the current broad repair/sync affordance with separate import, adoption, and semantic-repair outcomes.
- [ ] 4.3 Remove startup Xiuyuan Native Riff sync submission, full-sync timers, Browser-open incremental sync, and ReviewSyncManager Native Riff sync calls.
