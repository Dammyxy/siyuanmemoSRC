...
const TAB_CONTRACTS: Record<AIConceptCoachTabId, AIPromptContractDescriptor> = {
  ...
  'cdf-structure': {
    ...
    runtimeLines: [
      ...
      '最小合法示例：{"cdfStructure":{"anchors":[{"id":"anchor-1","conceptName":"概念","selected":true,"definitionCandidates":[{"id":"def-1","text":"定义候选","selected":true}],"descriptorGroups":[{"id":"group-1","title":"作用","selected":true,"items":[{"id":"item-1","text":"带来什么变化","selected":true}]}]}]}}。',
    ],
  },
  'real-world-triggers': {
    settingKey: 'conceptCoach',
