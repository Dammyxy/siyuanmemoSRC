...
const cdfSearchRuntime = createAiWorkbenchPaneCdfSearchRuntime();
const cdfSearchOpenKeys = cdfSearchRuntime.openKeys;
const cdfSearchQueryByKey = cdfSearchRuntime.queryByKey;
const cdfSearchBusyKeys = cdfSearchRuntime.busyKeys;
const cdfSearchErrors = cdfSearchRuntime.errors;
const cdfSearchResultsByKey = cdfSearchRuntime.resultsByKey;
const cdfConceptDocumentBusyKeys = cdfSearchRuntime.conceptDocumentBusyKeys;
const cdfConceptDocumentErrors = cdfSearchRuntime.conceptDocumentErrors;
...
const cdfSearchKey = cdfSearchRuntime.key;
...
const cdfSearchOpen = cdfSearchRuntime.isOpen;
const cdfSearchBusy = cdfSearchRuntime.isBusy;
const cdfConceptDocumentBusy = cdfSearchRuntime.isConceptDocumentBusy;
const cdfSearchQuery = cdfSearchRuntime.query;
const cdfSearchError = cdfSearchRuntime.error;
const cdfConceptDocumentError = cdfSearchRuntime.conceptDocumentError;
const cdfSearchResults = cdfSearchRuntime.results;
const setCdfSearchQuery = (messageId: string, anchorId: string, value: string): void => {
  cdfSearchRuntime.setQuery(messageId, anchorId, normalizeText(value));
};
...
<style scoped src="./AiWorkbenchPane.css"></style>
