...
describe('SRSBrowserAdapter', () => {
    ...
    describe('构造函数', () => {
        ...
        it('应该记录创建日志', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(
                '[SRSBrowserAdapter] Adapter created'
            );
    ...
    describe('initializeQueueView - 失败场景', () => {
        ...
        it('应该记录详细的错误日志', async () => {
            ...
            // 验证记录了错误日志
            expect(consoleSpy).toHaveBeenCalledWith(
                expect.stringContaining('[SRSBrowserAdapter] Failed to initialize queue view'),
                expect.objectContaining({
                    queueType,
                    error: errorMessage,
                })
    ...
    describe('onDataChanged - 观察者接口', () => {
        it('应该响应 card-updated 事件', async () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(
                expect.stringContaining('[SRSBrowserAdapter] Handling card-updated event: 2 cards')
            );
        ...
        it('应该响应 card-deleted 事件', async () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(
                expect.stringContaining('[SRSBrowserAdapter] Handling card-deleted event: 1 cards')
            );
    ...
    describe('destroy - 资源清理', () => {
        ...
        it('应该记录清理日志', async () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(
                '[SRSBrowserAdapter] Destroying adapter'
            );
            
            expect(consoleSpy).toHaveBeenCalledWith(
                '[SRSBrowserAdapter] Unregistered as observer'
            );
    ...
    describe('Task 1.4: 观察者事件处理测试', () => {
        describe('card-updated 事件处理', () => {
            it('应该处理单个卡片更新事件', async () => {
                ...
                // 验证调用了处理方法
                expect(consoleSpy).toHaveBeenCalledWith(
                    expect.stringContaining('[SRSBrowserAdapter] Handling card-updated event: 1 cards')
                );
            ...
            it('应该处理多个卡片更新事件', async () => {
                ...
                expect(consoleSpy).toHaveBeenCalledWith(
                    expect.stringContaining('[SRSBrowserAdapter] Handling card-updated event: 3 cards')
                );
            ...
            it('应该处理空卡片列表的更新事件', async () => {
                ...
                expect(consoleSpy).toHaveBeenCalledWith(
                    expect.stringContaining('[SRSBrowserAdapter] Handling card-updated event: 0 cards')
                );
        ...
        describe('card-deleted 事件处理', () => {
            ...
            it('应该处理多个卡片删除事件', async () => {
                ...
                expect(consoleSpy).toHaveBeenCalledWith(
                    expect.stringContaining('[SRSBrowserAdapter] Handling card-deleted event: 2 cards')
                );
            ...
            it('应该处理空卡片列表的删除事件', async () => {
                ...
                expect(consoleSpy).toHaveBeenCalledWith(
                    expect.stringContaining('[SRSBrowserAdapter] Handling card-deleted event: 0 cards')
                );
        ...
        describe('queue-changed 事件处理', () => {
            ...
            it('应该处理其他队列的变更事件', async () => {
                ...
                // 验证调用了处理方法
                expect(consoleSpy).toHaveBeenCalledWith(
                    expect.stringContaining('[SRSBrowserAdapter] Handling queue-changed event: final-drill')
                );
            ...
            it('应该处理没有指定队列类型的变更事件', async () => {
                ...
                // 验证调用了处理方法（显示 'all'）
                expect(consoleSpy).toHaveBeenCalledWith(
                    expect.stringContaining('[SRSBrowserAdapter] Handling queue-changed event: all')
                );
