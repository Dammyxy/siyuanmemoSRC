...
export const SORT_FIELD_CONFIGS: SortFieldConfig[] = [
  ...
  // 时间字段
  { colId: 'lastReview', label: '上次复习', i18nKey: 'sortByLastReview', icon: 'iconHistory' },
  { colId: 'due', label: '下次复习', i18nKey: 'sortByDueDate', icon: 'iconCalendar' },
  { colId: 'firstReview', label: '首次复习', i18nKey: 'sortByFirstReview', icon: 'iconClock' },
];
