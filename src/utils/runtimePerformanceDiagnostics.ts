...
const STARTUP_PROFILE_ALLOWED_OPERATIONS = new Set([
  'advanced-router.create',
  'application-context.create',
  'backend-worker.bootstrap',
  'doc-tree-review-scope-service.init',
  'frontend-instance-runtime.start',
  'integration-runtime.bind',
  'kernel-transaction-action-pump.start',
  ...
  'review-scope-card-creation-sync-service.init',
