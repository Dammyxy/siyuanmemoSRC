...
- Debt deferred: Projection-backed consumer rollout remains limited to RetrievalPractice / IncrementalLearning. FilterGroup, FinalDrill, Leech, NeuralRoam, and deeper manual/drill/leech/filter/neural projection parity stay on the existing explicit strategy path.
